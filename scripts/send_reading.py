...
message.attach(data=open(c.static_url('css/biblicity.css'), 'rb'), filename='biblicity.css')
message.attach(data=open(c.static_url('img/biblicity_icon.png'),'rb'), filename='biblicity_icon.png', content_disposition='inline')
message.attach(data=open(c.static_url('css/textapis/NLT.css'),'rb'), filename='NLT.css')
